...
export const PanelIcon = ({ size }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" aria-hidden="true">
    <rect x={1.5} y={1.5} width={13} height={13} rx={2.8} stroke="currentColor" strokeWidth={1.5} />
    <line x1={10.2} y1={2.6} x2={10.2} y2={13.4} stroke="currentColor" strokeWidth={1.5} />
  </svg>
)

export const FolderClosedIcon = ({ size }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" aria-hidden="true">
    <path
...
export const FolderOpenIcon = ({ size }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" aria-hidden="true">
    <path
...
export const FileCodeIcon = ({ size }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" aria-hidden="true">
    <path
      fillRule="evenodd"
      clipRule="evenodd"
...
export const PanelCollapseIcon = ({ size }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" aria-hidden="true">
    <line x1={12.5} y1={3} x2={12.5} y2={13} stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" />
    <path d="M3 8 H10 M7.8 5.6 L10.2 8 L7.8 10.4" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" fill="none" />
  </svg>
)

/** Git 变更（git 变更）：经典 git-branch 图形，用于文件树 ⇄ 变更列表切换 */
export const GitBranchIcon = ({ size }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" aria-hidden="true">
    <path d="M4.5 4.6v6.8" stroke="currentColor" strokeWidth={1.4} strokeLinecap="round" fill="none" />
    <circle cx={4.5} cy={3} r={1.7} stroke="currentColor" strokeWidth={1.4} fill="none" />
    <circle cx={4.5} cy={13} r={1.7} stroke="currentColor" strokeWidth={1.4} fill="none" />
    <circle cx={11.5} cy={3} r={1.7} stroke="currentColor" strokeWidth={1.4} fill="none" />
...
export const ExternalIcon = ({ size }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" aria-hidden="true">
    <path
      ...
      strokeLinecap="round"
    />
    <path d="M10 2.5h3.5V6M13.2 2.8 8.2 7.8" stroke="currentColor" strokeWidth={1.4} strokeLinecap="round" />
  </svg>
)
